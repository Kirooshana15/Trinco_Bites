...
import offer1 from "@/utils/assets/offer1.jpg";
import offer2 from "@/utils/assets/offer2.png";
import offer3 from "@/utils/assets/offer3.jpg";
import offer4 from "@/utils/assets/offer4.png";
import burgerImg from "@/utils/assets/burgar.jpg";
import seafoodImg from "@/utils/assets/seafood.png";
...
const banners = [
  ...
  },
  {
    id: 3,
    image: offer3,
    badge: { label: "Free Delivery", icon: Truck, color: "#fff", bg: "rgba(16,185,129,0.88)" },
    heading: "Free Delivery",
    subheading: "This Weekend Only",
    description: "No delivery charges across all restaurants this Saturday & Sunday. Order more, pay less.",
    cta: "Order Now",
    gradient: "linear-gradient(100deg, rgba(10,3,0,0.82) 0%, rgba(10,3,0,0.52) 48%, rgba(10,3,0,0.08) 100%)",
    accent: "#34d399",
  },
  {
    id: 4,
    image: seafoodImg,
    badge: { label: "Limited Time", icon: Clock, color: "#fff", bg: "rgba(14,116,144,0.88)" },
    heading: "Seafood Festival",
    subheading: "Fresh from Trinco's Shore",
    description: "Celebrate the ocean's bounty with exclusive deals on the freshest catches in town.",
    cta: "Explore Deals",
    gradient: "linear-gradient(100deg, rgba(10,3,0,0.85) 0%, rgba(10,3,0,0.55) 48%, rgba(10,3,0,0.10) 100%)",
    accent: "#67e8f9",
  },
  {
    id: 5,
    image: offer4,
    badge: { label: "Trending", icon: Zap, color: "#fff", bg: "rgba(239,68,68,0.88)" },
    heading: "Late Night",
    subheading: "Cravings? We've Got You",
    description: "Open till midnight. Hot food delivered fast, no matter how late the hunger strikes.",
    cta: "Order Now",
    gradient: "linear-gradient(100deg, rgba(10,3,0,0.88) 0%, rgba(10,3,0,0.58) 50%, rgba(10,3,0,0.10) 100%)",
    accent: "#fb923c",
  },
] as const;
...
export function OffersBannerCarousel() {
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 mt-6 mb-2">
      ...
      <div
        className="relative overflow-hidden aspect-[16/9] sm:aspect-[16/7] lg:aspect-[16/6]"
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-6 sm:px-14 max-w-[550px]">
              ...
              <motion.p
                ...
                className="font-black text-base sm:text-xl mb-2 sm:mb-3 leading-tight"
              ...
              <motion.p
                ...
                className="text-[11px] sm:text-sm leading-snug sm:leading-relaxed mb-4 sm:mb-6 max-w-[200px] sm:max-w-xs"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="w-fit px-5 py-2 sm:px-7 sm:py-3 rounded-xl sm:rounded-2xl text-[12px] sm:text-sm font-black tracking-wide"
                style={{
