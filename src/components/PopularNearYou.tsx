        ...
        {popular.map((r, i) => (
          ...
          >
            ...
            <div className="relative h-44 overflow-hidden">
              ...
              {/* Status Badge */}
              <div className="absolute top-3 right-3 px-2.5 py-1 rounded-full bg-green-500 text-white text-[10px] font-black shadow-sm">
                OPEN
              </div>
            </div>
            ...
            <div className="p-4">
              ...
              <p className="text-xs font-medium mb-3 opacity-60 truncate">{r.category} • {r.deliveryTime}</p>
